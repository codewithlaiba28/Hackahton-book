...
2. Install these extensions:
   ...
   - **Python Black Formatter** - Auto-format Python
   - **Clang-Format** - Auto-format C++
...
**Expected result**: Messages flowing from talker to listener ✓

## Done!

Your ROS 2 environment is ready to use!